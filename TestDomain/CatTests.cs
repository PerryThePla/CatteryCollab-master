...
public class CatTests
{
    ...
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Cat("", "Siamese", true, new DateOnly(2025, 08, 19), new DateOnly(2025, 10, 15), new DateOnly(2025, 08, 10), "gatto colore arancione"));
    }
    [TestMethod]
    public void Cat_BreedIsEmpty_ThrowsException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Cat("Romeo", "", false, new DateOnly(2025, 08, 19), new DateOnly(2025, 10, 15), new DateOnly(2025, 08, 10), "gatto colore arancione"));
    }
    ...
    public void Cat_GenerateID_WorksCorrectly()
    {
        ...
        Assert.AreEqual(13, cat.ID.Length);
    }
    [TestMethod]
    public void Cat_UpdateDepartureDate_WorksCorrectly()
    {
        ...
        Assert.AreEqual(new DateOnly(2025, 10, 15), cat.DepartureDate);
    }
